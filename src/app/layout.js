...
export default function RootLayout({ children }) {
  return (
    <html lang="es">
      <head>
        <title>
          Francisco Jesus Jalomo Chavez Portfolio - Desarrollador Web
        </title>
        <meta charSet="utf-8" />
        <meta
          name="title"
          content="Francisco Jesus Jalomo Chavez - Desarrollador Web"
        />
        ...
        <meta name="canonical" content="https://jesusjalomo.vercel.app" />
      </head>
      <body
        className={`${inter.className}before:contents before:-z-10 before:fixed  before:top-0 before:left-0 before:w-screen before:min-h-screen before:bg-gradient-to-tr before:from-background-700 before:via-background-800 before:to-background-900 before:bg-no-repeat  before:bg-cover min-h-screen w-full text-light text-xs md:text-md lg:text-lg relative grid max-w-[100%] max-w-screen `}
      >
        <Nav />
