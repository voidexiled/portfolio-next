    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
                ...
                <span className="">
                  <Link href="/projects">
                    <IconCornerUpLeft
                      width={40}
                      height={40}
                      className="transition-all rounded-md hover:bg-primary-300 hover:text-slate-800 hover:bg-opacity-50 hover:shadow-md p-1 lg:p-2 "
                    />
                  </Link>
                </span>
              </div>
                ...
                <span>
                  <a href={project.repoURL} target="_blank">
                    <IconBrandGithub
                      height={40}
                      width={40}
                      className="transition-all rounded-md hover:bg-primary-300 hover:text-slate-800 hover:shadow-xl p-1 lg:p-2 h-[32px] w-[32px] lg:h-[40px] lg:w-[40px] "
                    />
                  </a>
                </span>
                <span>
          ...
          <div className="relative flex w-full h-12 lg:h-24 justify-center items-center text-2xl lg:text-4xl">
            <span className="font-medium text-center text-light">
              {project && project.title}
            </span>
          </div>

          <p className="w-11/12 lg:w-10/12 pb-4 text-left text-light text-base leading-normal opacity-70">
